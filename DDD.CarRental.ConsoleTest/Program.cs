...
using System.Linq;
using DDD.CarRental.ConsoleTest;
using DDD.CarRental.Core.InfrastructureLayer.Services;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        services.AddSingleton<IDomainEventPublisher, SimpleEventPublisher>();
        ...
        services.AddTransient<GetAllDriversQueryHandler>();
        services.AddTransient<GetAllRentalsQueryHandler>();
        services.AddTransient<ReturnCarCommandHandler>();
        services.AddTransient<IPositionService, DummyPositionService>();
